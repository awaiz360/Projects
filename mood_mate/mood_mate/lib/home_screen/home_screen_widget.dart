  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserDataRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDataRecord> homeScreenUserDataRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homeScreenUserDataRecord = homeScreenUserDataRecordList.isNotEmpty
            ? homeScreenUserDataRecordList.first
            : null;
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            homeScreenUserDataRecord?.fName != null &&
                                    homeScreenUserDataRecord?.fName != ''
                                ? homeScreenUserDataRecord?.fName
                                : 'user',
                            'user',
                          ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/racket-removebg-preview.png',
                                          width: 100.0,
                                          height: 110.0,
                                          fit: BoxFit.fitHeight,
                                          alignment: const Alignment(1.0, 1.0),
