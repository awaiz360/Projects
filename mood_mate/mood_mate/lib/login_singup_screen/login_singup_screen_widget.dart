...
import 'login_singup_screen_model.dart';
export 'login_singup_screen_model.dart';

class LoginSingupScreenWidget extends StatefulWidget {
  const LoginSingupScreenWidget({super.key});

  @override
  State<LoginSingupScreenWidget> createState() =>
      _LoginSingupScreenWidgetState();
}

class _LoginSingupScreenWidgetState extends State<LoginSingupScreenWidget>
    with TickerProviderStateMixin {
  late LoginSingupScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginSingupScreenModel());
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/logo_app-removebg-preview_(1).png',
                      width: 300.0,
                      height: 453.0,
                      fit: BoxFit.cover,
                    ),
                              ...
                              children: [
                                Align(
                                  ...
                                  child: TabBar(
                                    ...
                                    indicatorColor: const Color(0xFF7BAE3E),
                                    indicatorWeight: 3.0,
                                    tabs: const [
                                      Tab(
                                        text: 'Create Account',
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      keyboardType:
                                                          TextInputType
                                                              .emailAddress,
                                                      validator: _model
                                                          .fnamefieldTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
