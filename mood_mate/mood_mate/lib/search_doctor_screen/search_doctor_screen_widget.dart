...
import 'search_doctor_screen_model.dart';
export 'search_doctor_screen_model.dart';

class SearchDoctorScreenWidget extends StatefulWidget {
  const SearchDoctorScreenWidget({super.key});

  @override
  State<SearchDoctorScreenWidget> createState() =>
      _SearchDoctorScreenWidgetState();
}

class _SearchDoctorScreenWidgetState extends State<SearchDoctorScreenWidget> {
  late SearchDoctorScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchDoctorScreenModel());
                  ...
                  child: Container(
                    ...
                    child: Visibility(
                      ...
                      child: FlutterFlowWebView(
                        content:
                            'https://rmi.edu.pk/search-doctor/${_model.textController.text}/0',
                        bypass: true,
                        height: 500.0,
                        verticalScroll: true,
