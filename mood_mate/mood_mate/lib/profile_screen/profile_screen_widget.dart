  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserDataRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDataRecord> profileScreenUserDataRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final profileScreenUserDataRecord =
            profileScreenUserDataRecordList.isNotEmpty
                ? profileScreenUserDataRecordList.first
                : null;
              ...
              child: Column(
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: Image.network(
                      profileScreenUserDataRecord!.photoUrl,
                      width: 300.0,
                      height: 300.0,
                      fit: BoxFit.contain,
                  ...
                  Text(
                    valueOrDefault<String>(
                      profileScreenUserDataRecord.fName,
                      'fname',
                    ),
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (confirmDialogResponse) {
                        ...
                        await profileScreenUserDataRecord.reference.delete();

                        context.pushNamed('Login_Singup_Screen');
                      } else {
                        context.pushNamed('ProfileScreen');
                      }
                    },
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          profileScreenUserDataRecord.age
                                              .toString(),
                                          'age',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                  ...
                                  Align(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/stand-removebg-preview.png',
                                        width: 150.0,
                                        height: 101.0,
                                        fit: BoxFit.fitHeight,
                                        alignment: const Alignment(1.0, 1.0),
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          profileScreenUserDataRecord.email,
                                          'email',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
