#ifndef TRACKER_CTRV_EKF_H
#define TRACKER_CTRV_EKF_H
...
class CTRVEKF {
 ...
 private:
  ...
  Matrix5d ComputeProcessNoise(double dt) const {
    ...
    constexpr double yaw_accel_var = 0.2 * 0.2;  // Variance of yaw acceleration
